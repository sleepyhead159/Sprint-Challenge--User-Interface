...
The logical instruction of laying out your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Dispaly block, will create a break point after the element, inline aligns the elements together.
...
Git is amazing, it is able to keep versions so you don't lose anything and able to collaborate all in pretty close live time.
